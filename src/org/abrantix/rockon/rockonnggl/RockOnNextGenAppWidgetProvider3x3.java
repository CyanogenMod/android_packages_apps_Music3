 ...
 */
public class RockOnNextGenAppWidgetProvider3x3 extends AppWidgetProvider {
    ...
    static final ComponentName THIS_APPWIDGET =
        new ComponentName(
                ...
                Constants.WIDGET_COMPONENT_3x3);
    
    private static RockOnNextGenAppWidgetProvider3x3 sInstance;
    
    static synchronized RockOnNextGenAppWidgetProvider3x3 getInstance() {
        if (sInstance == null) {
            sInstance = new RockOnNextGenAppWidgetProvider3x3();
        }
        return sInstance;
    }
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        ...
        updateIntent.putExtra(Constants.CMDNAME,
                RockOnNextGenAppWidgetProvider3x3.CMDAPPWIDGETUPDATE);
...
//        }
    ...
    void performUpdate(RockOnNextGenService service, int[] appWidgetIds) {
        ...
        final RemoteViews views = new RemoteViews(service.getPackageName(), R.layout.album_appwidget_3x3);
